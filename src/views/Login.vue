<template>
  <div>
        ...
        <section id="content">
          ...
          <div class="login_join_div">
            <form action id="login_form" @submit.prevent="joinRoom">
              <h1>
                <img src="/img/airtel-iq-2.png" style="max-width:140px;" />
              </h1>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <label>
                    ...
                    <a
                      target="_blank"
                      href="https://videoiq.airtel.in/developer/legals/tou/"
                    >Terms of Use</a> and
                    <a
                      target="_blank"
                      href="https://videoiq.airtel.in/developer/legals/privacy-policy/"
                    >Privacy Policy</a>
                  </label>
                </div>
              </div>
    ...
    <div class="footer">&copy; Airtel IQ. All Rights Reserved.</div>
  </div>
</template>
